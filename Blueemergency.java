...
@Autonomous(name="Blueemergency", group="FinalBot")
public class Blueemergency extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.BackMotorRight.setPower(0.0);
        sleep(1000);
        robot.FrontMotorLeft.setPower(-0.8);
        robot.FrontMotorRight.setPower(0.8);
        robot.BackMotorLeft.setPower(-0.8);
        robot.BackMotorRight.setPower(0.8);
        sleep(4000);
        robot.FrontMotorLeft.setPower(0.0);
        robot.FrontMotorRight.setPower(0.0);
        robot.BackMotorLeft.setPower(0.0);
